...
import com.one97.common.util.ExceptionHelper;
import com.one97.common.util.Size;
...
public class HttpServerTransport extends AbstractLifecycleService<HttpServerTransport> {
    ...
    private void internalStart() {
        ...
        serverBootstrap.setPipelineFactory(new DefaultChannelPipeline(this));
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e) {
        ...
        if (e.getCause() instanceof ReadTimeoutException) {
            ...
            if (!ExceptionHelper.isCloseConnectionException(e.getCause())) {
                ...
                // one can throw SpockException to tell here that what happened was purely
