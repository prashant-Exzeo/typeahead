...
public class HttpRestResponse extends BaseHttpResponse {
    ...
    public HttpRestResponse(HttpResponseStatus status, String contentType) {
        ...
        try {
            ...
            throw new TypeaheadException("IO Exception happened during initialization of JSONGenerator");
        }
    }
    ...
    public HttpRestResponse writeStartArray() {
        try {
            ...
            throw new TypeaheadException("writeStartArray failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeEndArray() {
        try {
            ...
            throw new TypeaheadException("writeEndArray failed", e);
        }
    ...
    public HttpRestResponse writeStartObject() {
        try {
            ...
            throw new TypeaheadException("writeStartObject failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeEndObject() {
        try {
            ...
            throw new TypeaheadException("writeEndObject failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeFieldName(String name) {
        try {
            ...
            throw new TypeaheadException("writeFieldName failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeString(String text) {
        try {
            ...
            throw new TypeaheadException("writeString failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeRawUTF8String(byte[] text, int offset, int length) {
        try {
            ...
            throw new TypeaheadException("writeRawUTF8String failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeUTF8String(byte[] text, int offset, int length) {
        try {
            ...
            throw new TypeaheadException("writeUTF8String failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeRaw(String text) {
        try {
            ...
            throw new TypeaheadException("writeRaw failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeRawValue(String text) {
        try {
            ...
            throw new TypeaheadException("writeRawValue failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeBinary(Base64Variant b64variant, byte[] data, int offset, int len) {
        try {
            ...
            throw new TypeaheadException("writeBinary failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeNumber(int v) {
        try {
            ...
            throw new TypeaheadException("writeNumber failed", e);
        }
        return this;
    }
    ...
    public HttpRestResponse writeBoolean(boolean state) {
        ...
        try {
            ...
            throw new TypeaheadException("writeBoolean failed", e);
        }
    ...
    public HttpRestResponse writeNull() {
        try {
            ...
            throw new TypeaheadException("writeNull failed", e);
        }
        return this;
    }
    ...
    public ChannelBuffer content() {
        ...
        try {
            ...
            throw new TypeaheadException("channel buffer failed", e);
        }
